package com.example.harmonyapp.ext
...
import com.example.harmonyapp.HarmonyGalleryApp
import com.example.harmonyapp.utils.Constants
import java.io.File
...
fun Bitmap.saveToInternalStorage(name: String): Uri? {
    val context = HarmonyGalleryApp.applicationContext()
